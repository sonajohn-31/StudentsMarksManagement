<%@ Page Title="" Language="C#" MasterPageFile="~/SMS1.Master" AutoEventWireup="true" CodeBehind="HMark.aspx.cs" Inherits="StudentsMarksManagement.HMark" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div>
            ...
            <h2 class="auto-style7" style="color: #003399; font-size: x-large; font-family: Algerian; text-decoration: underline;">Half Yearly Exam Details </h2>
            
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <div class="auto-style5">
                    <strong>
                    <asp:GridView ID="GridFaculty" runat="server" Width="90%" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" CssClass="auto-style1" Height="205px" >
                        <Columns>
