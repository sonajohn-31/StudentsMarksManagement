<%@ Page Title="" Language="C#" MasterPageFile="~/SMS2.Master" AutoEventWireup="true" CodeBehind="ChangePasswordStd.aspx.cs" Inherits="StudentsMarksManagement.ChangePasswordStd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="auto-style5">
        ...
        <div class="user-deatils">
            ...
            <div class="input-box">
                 <asp:Button ID="ButtonAdd1" runat="server" Text="Change Password" CssClass="btinput" OnClick="ButtonAdd1_Click" BorderColor="#660066" BorderStyle="Double" BorderWidth="2px" />
            </div>
